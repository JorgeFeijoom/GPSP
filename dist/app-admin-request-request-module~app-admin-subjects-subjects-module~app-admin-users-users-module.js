(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["app-admin-request-request-module~app-admin-subjects-subjects-module~app-admin-users-users-module"],{

/***/ "./node_modules/@sweetalert2/ngx-sweetalert2/fesm5/sweetalert2-ngx-sweetalert2.js":
/*!****************************************************************************************!*\
  !*** ./node_modules/@sweetalert2/ngx-sweetalert2/fesm5/sweetalert2-ngx-sweetalert2.js ***!
  \****************************************************************************************/
...
SwalPartialTargets = /** @class */ (function () {
    function SwalPartialTargets() {
        this.title = function () { return sweetalert2__WEBPACK_IMPORTED_MODULE_1___default.a.getTitle(); };
        this.content = function () { return sweetalert2__WEBPACK_IMPORTED_MODULE_1___default.a.getContent(); };
        this.actions = function () { return sweetalert2__WEBPACK_IMPORTED_MODULE_1___default.a.getActions(); };
        this.confirmButton = function () { return sweetalert2__WEBPACK_IMPORTED_MODULE_1___default.a.getConfirmButton(); };
        this.cancelButton = function () { return sweetalert2__WEBPACK_IMPORTED_MODULE_1___default.a.getCancelButton(); };
        this.footer = function () { return sweetalert2__WEBPACK_IMPORTED_MODULE_1___default.a.getFooter(); };
    }
 ...
 */
/** @type {?} */
var SwalDefaults = new _angular_core__WEBPACK_IMPORTED_MODULE_3__["InjectionToken"]('SwalDefaults');
/**
 * @param {?=} options
 * @return {?}
 */
...
var SwalComponent = /** @class */ (function () {
    function SwalComponent(defaultSwalOptions) {
         ...
         */
        this.beforeOpen = new _angular_core__WEBPACK_IMPORTED_MODULE_3__["EventEmitter"]();
        /**
        ...
        this.nativeSwal = sweetalert2__WEBPACK_IMPORTED_MODULE_1___default.a;
    ...
    function () {
        ...
        /** @type {?} */
        var options = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, this.defaultSwalOptions, this.options, { onBeforeOpen: function (modalElement) {
        ...
        //=> Show the Swal!
        /** @type {?} */
        var promise = sweetalert2__WEBPACK_IMPORTED_MODULE_1___default.a.fire(options);
    ...
    SwalComponent.ctorParameters = function () { return [
        { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Inject"], args: [SwalDefaults,] }] }
    ]; };
    SwalComponent.propDecorators = {
        title: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        titleText: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        text: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        html: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        ...
        toast: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        target: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        ...
        grow: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        customClass: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        timer: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        animation: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        allowOutsideClick: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        allowEscapeKey: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        allowEnterKey: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        showConfirmButton: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        showCancelButton: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        confirmButtonText: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        cancelButtonText: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        confirmButtonColor: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        cancelButtonColor: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        confirmButtonClass: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        cancelButtonClass: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        confirmButtonAriaLabel: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        cancelButtonAriaLabel: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        buttonsStyling: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        reverseButtons: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        focusConfirm: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        focusCancel: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        showCloseButton: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        closeButtonAriaLabel: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        showLoaderOnConfirm: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        preConfirm: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        imageUrl: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        imageWidth: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        imageHeight: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        imageAlt: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        imageClass: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        inputPlaceholder: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        inputValue: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        inputOptions: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        inputAutoTrim: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        inputAttributes: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        inputValidator: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        inputClass: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        progressSteps: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        currentProgressStep: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        progressStepsDistance: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        beforeOpen: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Output"] }],
        open: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Output"] }],
        close: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Output"] }],
        confirm: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Output"] }],
...
var SwalDirective = /** @class */ (function () {
    ...
    Object.defineProperty(SwalDirective.prototype, "swal", {
        ...
        function (options) {
            if (options instanceof SwalComponent) {
                ...
                this.swalOptions = sweetalert2__WEBPACK_IMPORTED_MODULE_1___default.a.argsToParams(options);
            }
            else {
    ...
    SwalDirective.propDecorators = {
        swal: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
        confirm: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Output"] }],
        cancel: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Output"] }],
        onHostClicked: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["HostListener"], args: ['click', ['$event'],] }]
    };
...
var SwalPartialDirective = /** @class */ (function () {
    ...
    SwalPartialDirective.ctorParameters = function () { return [
        ...
        { type: SwalComponent, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Host"] }] }
    ]; };
    SwalPartialDirective.propDecorators = {
        swalPartial: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }]
    };
...
//# sourceMappingURL=app-admin-request-request-module~app-admin-subjects-subjects-module~app-admin-users-users-module.js.map