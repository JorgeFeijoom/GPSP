...
var RequestListComponent = /** @class */ (function () {
    ...
    RequestListComponent.prototype.installRequest = function (request) {
        ...
        this
            ...
            .subscribe(function (request) {
            _this.toastr.success('Se ha marcado como instalada la petición.', 'Hecho!');
            _this.ngOnInit();
        }, function (error) {
            _this.toastr.error('Ha ocurrido un error inesperado. Consulta con un administrador.', 'Error!');
        });
...
var RequestService = /** @class */ (function () {
    ...
    RequestService.prototype.installRequest = function (requestId) {
        var data = { 'requestId': requestId };
        var url = '/api/request/install';
        return this.http
            .post(url, data, { headers: {}, responseType: 'text' });
    };
